...
export const useStore = create(
  ...
  postProcessingSettings: {
    ...
    // SMAA
    smaaEnabled: false,
    // Outline (uses Selection/Select from drei-postprocessing)
    outlineEnabled: false,
    outlineEdgeStrength: 5,
    outlineBlur: false,
    outlineColor: '#ffffff',
    // Tone Mapping
    toneMappingEnabled: false,
    toneMappingMode: 4, // ACESFilmic
    toneMappingExposure: 1.0,
    // Custom shaders (saved GLSL effects)
    customEffects: [],
  },
